...
def lnlike_gauss_Lin(theta, spec, specE , x, waves0, fac0, facN0, names0, n_lines, vals, skew, lorentz, outflow):
    '''This function calculates the likelihood of a double model for the spectrum'''
    model=mod.line_model(theta, waves0, fac0, facN0, names0, n_lines, vals, x=x, skew=skew, lorentz=lorentz, outflow=outflow)
...
def lnprob_gauss_Lin(theta, spec, specE, x, Infvalues, Supvalues, valsp, waves0, fac0, facN0, names0, n_lines, vals, skew, lorentz, outflow):
    ...
    if not np.isfinite(lp):
        ...
        return lp + lnlike_gauss_Lin(theta, spec, specE, x, waves0, fac0, facN0, names0, n_lines, vals, skew, lorentz, outflow) 

...
def lnprior_gauss_Lin(theta, valsp, At=0.05,dv1t=200,sim=False, single=False, skew=False, broad=True):
...
def lnprob_gauss_Lin(theta, spec, specE, x, xo1, xo2, xo3, At, dv1t, sim, lfac12, single, skew, broad, lorentz, valsp):
    '''This function calculates the posterior of the double model for the spectrum'''
    lp = lnprior_gauss_Lin(theta, valsp, At=At, dv1t=dv1t, sim=sim, single=single, skew=skew, broad=broad)

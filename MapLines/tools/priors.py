            ...
            if broad:
                ...
                if n_line:
                    ...
                    if outflow:
                        ...
                        if ((A1 >= valsp['a1i']) and (A1 <= valsp['a1s'])) and ((A3 >= valsp['a3i']) and (A3 <= valsp['a3s'])) and ((fwhm1 >= valsp['fwhm1i']) and (fwhm1 <= valsp['fwhm1s'])) and ((dv1 >= valsp['dv1i']) and (dv1 <= valsp['dv1s'])) and((A1o >= valsp['a1i']) and (A1o <= valsp['a1s'])) and ((A3o >= valsp['a3i']) and (A3o <= valsp['a3s'])) and ((fwhmO >= valsp['fwhmOi']) and (fwhmO <= valsp['fwhmOs'])) and ((dvO >= valsp['dvOi']) and (dvO <= valsp['dvOs'])): 
                            return 0.0
                        else:
                            return -np.inf    
                    else:

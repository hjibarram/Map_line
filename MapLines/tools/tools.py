    ...
    if data_lines:
        ...
        for valt in vals:
            ...
            try:
                ...
                sys.exit()
        return  valsp,n_lines,wavec1,wavec2,Inpvalues,Infvalues,Supvalues,waves0#,names0,vals0,vals,valsL,valsH,fac0,facN0,velfac0,velfacN0,fwhfac0,fwhfacN0,region
    else:

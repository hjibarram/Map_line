...
def line_model(theta, x=0, xo1=0, xo2=0, xo3=0 ,ret_com=False, lfac12=2.93):
    ...
    hGb,hGr=emission_line_model(x, xo=xo2, A=A3, dv=[dv1,dv2], fwhm=[fwhm1,fwhm1], fac=[fac])
    ...
    A5=A1/lfac12
    nGb,nGr=emission_line_model(x, xo=xo3, A=A5, dv=[dv1,dv2], fwhm=[fwhm1,fwhm1], fac=[fac])
    ...
    hGbr=emission_line_model(x, xo=xo2, A=A7, dv=[dv3], fwhm=[fwhm2])

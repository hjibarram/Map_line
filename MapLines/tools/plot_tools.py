...
def plot_single_map(file,valmax,valmin,name='',sb=False,logs=False,zerofil=False,scalef=1.0,basefigname='Ha_vel_map_NAME',path='',hd=0,indx=0,tit='',lab='',facp=0.8,cont=False,alpha=1,orientation=None,location=None,savef=False,fig_path=''):
